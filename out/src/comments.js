...
exports.readCommentsForLine = exports.stripAllComments = exports.setCustomCommentPrefix = void 0;
// Is set on start and whenever the settings change.
// It holds all prefixes (like ';' and '//') that are used as comment prefixes.
let commentEtcPrefixes;
let commentHoverPrefixes;
let commentHoverPrefixesSameLine;
let singleLineCommentsSet;
/**
 * Sets the characters used as comments.
 * @param prefix Text from toggleCommentPrefix.
 */
function setCustomCommentPrefix(prefix) {
    singleLineCommentsSet = new Set([';', '//']);
    if (prefix)
...
exports.setCustomCommentPrefix = setCustomCommentPrefix;
/**
 ...
 */
function stripAllComments(lines) {
...
exports.stripAllComments = stripAllComments;
/**
 ...
 */
function readCommentsForLine(lines, lineNr) {
    // Safety check
...
exports.readCommentsForLine = readCommentsForLine;
